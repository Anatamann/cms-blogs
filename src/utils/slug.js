...
const paths = {
  ...
  admin: {
    ...
    authors: () => '/mantri/authors',
    authorNew: () => '/mantri/authors/new',
    authorEdit: (id) => `/mantri/authors/${id}/edit`,
    authorDelete: (id) => `/mantri/authors/${id}/delete`,
    analytics: () => '/mantri/analytics',
    tags: () => '/mantri/tags',
